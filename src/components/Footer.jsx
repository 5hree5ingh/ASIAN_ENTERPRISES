            ...
            <div className="container footer-grid">
                ...
                <div className="footer-col">
                    ...
                    <div className="footer-contact">
                        <div className="fcontact-item" style={{alignItems: 'flex-start'}}>
                            ...
                            <span><strong>Head Office:</strong> Plot -2A, Shivani puram-2, Jamalpur kalan, Jagjeetpur Road, Raja Garden, Haridwar -249407(U.K) India</span>
                        </div>
                        <div className="fcontact-item" style={{alignItems: 'flex-start'}}>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{marginTop: '3px', flexShrink: 0}}>
                                <path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z" /><polyline points="9 22 9 12 15 12 15 22" />
                            </svg>
                            <span><strong>Lab Address:</strong> Behind ICICI Bank, Chandigarh–Ambala Highway, Dera Bassi, SAS Nagar, Punjab 140507</span>
                        </div>
                        <div className="fcontact-item">
                            ...
                            <span>+91 97601 88223 / +91 94111 11480</span>
                        </div>
                        <div className="fcontact-item">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
