        ...
        <div className="vcat-page page-enter">
            ...
            <section className="vcat-hero">
                ...
                <div className="container vcat-hero-inner">
                    <motion.div className="vcat-breadcrumb"
                        initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
                        <Link to="/">Home</Link><ChevronRight size={14} />
                        <Link to="/validation">Validation</Link><ChevronRight size={14} />
                    ...
                    <motion.div className="vcat-hero-actions"
                        ...
                        <a href="https://wa.me/919760188223" target="_blank" rel="noopener noreferrer" className="vcat-btn-primary">
                            Get a Free Quote <ArrowRight size={18} />
                        </a>
                        <button className="vcat-btn-outline" onClick={() => navigate('/contact')}>
                            Contact Us
                        </button>
                    </motion.div>
                </div>
